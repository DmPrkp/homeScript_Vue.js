...
let webStore = new Vue({
	...
	data: {
		...
		profile_data: {
			...
			bike: 'Honda CB 750',
			bike_img: 'img/honda.jpg',
			bike_story: `По задумке кастом должен быть похож на олд-таймеры 70-х, поэтому мотоциклу Honda CB750 специально состарили внешность, используя, в том числе, некрашеный чистый металл, но в тоже время установили современную электрику, стилизованную под 70-е.
			HONDA CB750 «ANVIL»
Wrench Kings приступили к работе, разобрав Honda CB750 и оставив только раму с мотором и колеса. С этого момента начинается волшебство – глядя на голый мотоцикл, в голове начинают формироваться линии будущего кастома. В результате чего опустили переднюю вилку, обрезали хвост рамы и поставили топливный бак с модели 70-х годов – он идеально вписался в раму, но идей как окончательно должна выглядеть задняя часть долго небыло и облик хвоста сформировался только после установки бака – линии заднего обтекателя стали соответствовать линиям бака.
ДЕТАЛИ
После формирования облика мотоцикл был снова разобран. Рама была зачищена до блеска и отправлена на порошковую окраску. Силовая установка была обслужена, отремонтирована и заново покрашена. После того, как все детали были подготовлены, приступили к окончательной сборке. Также Honda CB750 «Anvil» получил красивое тонкое сидение.`
		},
		product1:
		{
			src: 'img/m600.jpg',
